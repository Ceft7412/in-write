import { View, Text, StyleSheet, ColorSchemeName, useColorScheme, Pressable, useWindowDimensions } from "react-native";
...
export default function EvenGridView() {
  const { filteredNotes, isSelectionMode, toggleNoteSelection, selectedNoteIds, setSelectedNoteId } = useTabs();
